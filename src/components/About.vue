<template>
  <div class="min-h-screen flex flex-col items-center justify-center text-center px-4 py-12 bg-gradient-to-r from-yellow-500 via-lime-500 to-green-500">
    <h1 class="text-5xl font-bold text-white mb-6">À propos de Pandemetrix</h1>
    ...
    <p class="text-md text-white mt-6">
